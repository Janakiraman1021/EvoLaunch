    ...
    <div className="space-y-12 animate-in fade-in duration-1000 pt-8 max-w-7xl mx-auto">
      <div className="flex flex-wrap items-center justify-between gap-8">
        <div className="flex flex-col gap-4">
          <h1 className="text-4xl font-bold text-white tracking-tight italic">Ecosystem Explorer</h1>
        ...
        <div className="flex items-center gap-4 bg-white/[0.03] p-2 rounded-2xl border border-white/10 w-full max-w-md">
          ...
          <input 
            ...
            className="bg-transparent border-none outline-none text-white text-sm w-full py-3 px-2 placeholder:text-muted/30"
          />
          <button className="px-6 py-2.5 bg-secondary border border-white/5 rounded-xl text-[10px] font-bold text-gold uppercase tracking-widest hover:border-gold/30 transition-all">
            <Filter size={16} />
          </button>
        </div>
      </div>
        ...
        {[
          ...
          <div key={i} className="luxury-card p-10 flex flex-col gap-8 group">
            ...
            <div className="relative z-10">
              <h3 className="text-xl font-bold text-white tracking-tight group-hover:text-gold transition-colors">{item.name}</h3>
            ...
            <div className="flex justify-between items-center relative z-10 pt-4 border-t border-white/5">
              <div className="text-sm font-bold text-white tracking-tight">{item.cap}</div>
