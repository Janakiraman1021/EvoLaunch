...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-background text-white font-sans selection:bg-gold/30 relative overflow-x-hidden">
            ...
            {/* Top Navigation */}
            <nav className="fixed top-0 w-full border-b border-white/[0.05] bg-background/80 backdrop-blur-md z-50">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        {/* Icon navigates to dashboard */}
                        <button
                            onClick={() => mode === 'ai' ? router.push('/ai/dashboard') : router.push('/dashboard')}
                            className="w-10 h-10 rounded-xl bg-gold relative flex items-center justify-center transform hover:scale-105 transition-all shadow-[0_0_15px_rgba(201,168,76,0.3)] cursor-pointer"
                        >
                            <Terminal className="text-background w-5 h-5 absolute" />
                        </button>
                        <span className="text-xl font-black tracking-tight flex items-center gap-2">
                            EvoLaunch <span className="text-gold">Protocol</span>
                        </span>
                    </div>
            ...
            <main className="relative z-10 pt-32 pb-24">
                ...
                <section className="max-w-7xl mx-auto px-6 pt-20 pb-32 text-center">
                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-gold/20 bg-gold/[0.02] mb-8">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gold">V1 Mainnet Live</span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
                        <button
                            ...
                            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gold text-background font-black text-sm uppercase tracking-[0.15em] shadow-[0_0_20px_rgba(201,168,76,0.3)] hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-3"
                        >
                        ...
                        <button
                            ...
                            className="w-full sm:w-auto px-8 py-4 rounded-xl border border-white/10 bg-white/[0.02] text-white font-black text-sm uppercase tracking-[0.15em] hover:border-gold/50 hover:bg-gold/5 transition-all flex items-center justify-center gap-3 group"
                        >
                            <Cpu size={18} className="text-white/40 group-hover:text-gold transition-colors" /> Launch AI Agent
                        </button>
                        <button
                ...
                <section id="architecture" className="max-w-7xl mx-auto px-6 py-24 border-t border-white/[0.05]">
                    <div className="mb-16 text-center">
                        <h2 className="text-3xl font-black tracking-tight mb-4 text-gold">Dual Engine Architecture</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {/* Human Side */}
                        <div className="p-10 rounded-3xl border border-white/5 bg-secondary hover:border-emerald-400/20 transition-all group">
                        ...
                        <div className="p-10 rounded-3xl border border-white/5 bg-secondary hover:border-gold/20 transition-all group relative overflow-hidden">
                            ...
                            <div className="w-12 h-12 rounded-xl bg-gold/10 flex items-center justify-center mb-8 border border-gold/20 relative z-10">
                            ...
                            <ul className="space-y-4 relative z-10">
                                {['Trading agents', 'Yield optimization agents', 'Arbitrage execution agents', 'Data monetization agents', 'Programmable strategy bounds'].map((item, i) => (
                                    <li key={i} className="flex items-center gap-3 text-sm font-bold text-gold/80">
                                        <div className="w-1.5 h-1.5 rounded-full bg-gold" /> {item}
                                    </li>
                                ))}
                            </ul>
                        </div>
                ...
                <section id="how-it-works" className="max-w-7xl mx-auto px-6 py-24 border-t border-white/[0.05]">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        {/* AI Flow */}
                        <div>
                            <h3 className="text-xl font-black text-gold mb-8 flex items-center gap-3">
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    <div key={i} className="flex gap-6 group">
                                        <div className="w-10 h-10 rounded-full border border-white/10 flex flex-shrink-0 items-center justify-center font-black text-sm text-white/40 group-hover:border-gold group-hover:text-gold transition-colors">
                                            {i + 1}
                                        </div>
                                        <div>
                                            <h4 className="font-black text-lg mb-1">{step.t}</h4>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i} className="p-8 border border-white/5 bg-white/[0.01] rounded-2xl">
                                <item.i className="text-gold mb-5 w-6 h-6" />
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        ...
                        <div className="lg:w-1/2 w-full">
                            <div className="aspect-square w-full max-w-md mx-auto relative flex items-center justify-center p-12 overflow-hidden border border-white/10 rounded-full">
                                <div className="absolute inset-0 bg-gold/5 rounded-full animate-gold-pulse" />
                                <div className="absolute inset-4 border border-white/5 rounded-full" />
                                <div className="absolute inset-8 border border-white/10 rounded-full border-dashed animate-spin-slow" />
                                <Shield className="w-24 h-24 text-gold relative z-10" />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-32 bg-gold relative overflow-hidden">
                    <div className="absolute inset-0 bg-background opacity-90 mix-blend-multiply" />
                    <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                        <h2 className="text-4xl font-black tracking-tighter mb-8 text-white">
                            From token economies to <span className="text-gold">autonomous AI economies</span>.
                        </h2>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-16 text-left">
                            {['AI strategy marketplace', 'Cross-chain agents', 'DAO-controlled agents', 'Institutional agent pools'].map((item, i) => (
                                <div key={i} className="p-6 border border-gold/20 bg-gold/5 rounded-2xl">
                                    <div className="text-[10px] font-black uppercase tracking-[0.2em] text-gold mb-2">Roadmap</div>
