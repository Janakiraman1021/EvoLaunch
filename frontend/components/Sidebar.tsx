...
<<<<<<< HEAD
    <>
      ...
      {/* Sidebar */}
      <nav className={`fixed left-0 top-0 h-screen w-64 flex flex-col py-6 px-4 glass-panel z-50 border-r border-gold/10 transition-all duration-300 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
        } md:w-80`}>
        {/* Logo Section */}
